## Project Intent
- Assume quizz-cli-app.ipynb was made using the following kiro-style workflow. 
- The intent of the project is to create kiro artifacts accurately and exhaustively by reverse engineering the code of `quizz-cli-app.ipynb`
- `quizz\.kiro` has relevant artifacts of the distributable library used in `quizz-cli-app.ipynb`
